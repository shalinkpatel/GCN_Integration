...
from ExplanationEvaluation.explainers.BayesianExplainerNF import BayesianExplainer
...
def select_explainer(explainer, model, graphs, features, task, epochs, lr, reg_coefs, temp=None, sample_bias=None):
    ...
    if explainer == "PG":
        ...
        return BayesianExplainer(model, graphs, features, task, epochs=epochs, lr=lr)
    else:
